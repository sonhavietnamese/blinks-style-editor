  ...
  useEffect(() => {
    const onUpdate = (evt: MouseEvent) => {
      if (startVal) {
        ...
        const blinkElement = document.querySelector(".blink") as HTMLElement
        blinkElement?.style?.setProperty(
          "--blink-border-radius-rounded-2xl",
          `${evt.clientX - snapshot}px`,
        )
      }
    }
  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        <span className="mt-3 text-xs text-[#000000B3]">Background</span>
        <div className="mt-2 flex gap-2">
          <button className="aspect-square w-5 rounded-full border border-[hsl(0_0%_92%)] bg-white"></button>
          <button className="aspect-square w-5 rounded-full border border-[hsl(0_0%_92%)] bg-black"></button>
        </div>
      </div>
      <div className="flex w-full flex-col">
        <label className="mt-3 text-xs text-[#000000B3]">Border Radius</label>
        <div className="mt-2 flex gap-2">
          <fieldset className="relative w-full">
            <div
              onMouseDown={onStart}
              className="absolute bottom-0 top-0 z-[2] flex cursor-ew-resize items-center px-3 text-[12px]"
            >
              <svg
                width="9"
                height="9"
            ...
            <input
              ...
              min={0}
              max={64}
              className="block w-full rounded-lg border border-[#e6e6e6] p-2 pl-8 pr-10 text-sm leading-3 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
            />

            <div
              onMouseDown={onStart}
              className="absolute bottom-0 right-0 top-0 z-[2] flex cursor-ew-resize items-center px-2 text-[12px]"
            >
              <kbd className="rounded bg-[#ebebeb] p-1.5 py-[1px] text-[11px]">
                rem
              </kbd>
            </div>
          </fieldset>
