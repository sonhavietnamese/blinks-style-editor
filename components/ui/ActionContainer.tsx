...
// import { isPostRequestError, isSignTransactionError } from '../utils/type-guards.ts'
import { ActionLayout, DisclaimerType, type Disclaimer, type StylePreset } from './ActionLayout'
...
// const getOverallActionState = (action: Action, websiteUrl?: string | null): ActionStateWithOrigin => {
...
// const checkSecurityFromActionState = (state: ActionStateWithOrigin, normalizedSecurityLevel: NormalizedSecurityLevel): boolean => {
//   return checkSecurity(state.action, normalizedSecurityLevel.actions) && state.origin
...
export const ActionContainer = ({
  ...
  return (
    <Experimental__ActionLayout
      stylePreset={stylePreset}
      type={'trusted'}
      title='Predict and Win $SEND from Pool'
      description='Bet on which token goes higher in the next 24 hours: tremp, TRUMP, KAMA, boden'
